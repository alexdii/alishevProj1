...
public class PhraseOMatic {
    public static void main(String[] args) {
        String[] wordListOne = {"круглосуточный", "зависший", "трехзвенный", "подвешенный на",
                "передвижной", "длинный и толстый", "300-метровый", "идеальный", "импортный",
        ...
        String[] wordListTwo = {"уполномоченный", "трудный", "ипотечный", "придуманный для", "социалистический",
                "развитой", "теневой", "сервисный", "куриный", "солнечный", "чистый продукт",
        ...
        String[] wordListThree = {"процесс", "пункт разгрузки", "генетический крах", "нанотехнологии",
                "внешняя подвеска", "язвенник", "идеалист", "выход из положения", "тип структуры",
                "товаровед", "талант", "подход", "атеросклероз", "уровень завоеванного внимания", "портал",
